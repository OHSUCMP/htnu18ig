...
old_bp = "/Users/yateam/HTN/htnu18ig/input/tests/plandefinition/Pharma/P-ClonidinePatch/Observation/observation-P-ClonidinePatch-8.json"
...
with open(old_bp, 'r') as f:
    ...
    new_file_content = new_file_content.replace('2023-08-08', effectiveDate)
    new_file_content = new_file_content.replace('135', sbp)
    new_file_content = new_file_content.replace('85', dbp)
